...
const Profile = () => {
  ...
  return (
    <div className="section container" style={{ maxWidth: '600px' }}>
      ...
      {saved && (
        <div style={{ background: '#dcfce7', color: '#15803d', padding: '0.75rem 1rem', borderRadius: 'var(--radius)', marginBottom: '1.25rem' }}>
      ...
      <form onSubmit={handleSubmit} className="card-white" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <div>
          <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.4rem' }}>Default Service Location</label>
          <input
            type="text"
            className="form-control"
